...
Because just about any predictive model has the same objective, they cal all be broken down into about the same process
...
4. Split your training data up many more times to tune models

5. "Feature engineer" your data splits (center-scale, box-cox transformations, polynomials, etc.)

6. Once you've got your best model, train it on the training data, test it on the testing

7. Repeat for many different models
